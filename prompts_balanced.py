...
Your task is to analyze provided clinical text and identify relevant SDoH categories and sub-categories based on explicit evidence or strong implication from the text.
...
2. Identify SDoH *categories* from the list above that are **explicitly present or strongly implied**. Multiple selections are allowed.
...
4. Include categories/sub-categories that are CURRENT or STRONGLY IMPLIED as current.
   • Current: present-tense or no past/“resolved” markers; allow “now”/“currently”.
   • Patient-specific: about the patient (not family members).
   • Actual OR recently completed actions (≤3 months): e.g., “approved for SNAP”, “moved into shelter”.
   • Exclude explicit denials and clearly historical-only mentions (“in 2019”, “previously”).
